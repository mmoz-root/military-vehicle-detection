...
def main():
    ...
    ap.add_argument("--data", default=str(PROJECT_ROOT / "data" / "dataset_clean"),
                    help="dataset root (contains data.yaml)")
    ap.add_argument("--out", default=str(PROJECT_ROOT / "data" / "audit_out"),
                    help="output folder for report + samples")
